...
acf_form_head();
wp_enqueue_style('edit_custom_event', get_stylesheet_directory_uri() . '/styles/events/edit-event.css');
...
<form method="post" enctype="multipart/form-data" data-datepicker_format="<?php echo esc_attr( tribe_get_option( 'datepickerFormat', 0 ) ); ?>">
	...
	<?php 
		acf_form(array(
			'form' => false,
	        'field_groups' => array(5221), // Same ID(s) used before
			'id' => 'acf_group_add_event',
			'fields' => array('secondary_title'),
	...
	<?php 
		acf_form(array(
	        ...
	        'field_groups' => array(5221), // Same ID(s) used before
			'id' => 'acf_group_add_event',
			'fields' => array('header_background_image', 'speakers'),
	        'html_submit_spinner' => '<span class="acf-spinner"></span>'
	    ));
